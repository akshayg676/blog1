  ...
  return (
    <Box className={classes.container}>
      ...
      <Box className={classes.subHeading}>
        ...
        <Typography>22 june 2021</Typography>
      </Box>
      <Typography>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod ullam
        saepe, et vel quis maiores nostrum molestias aspernatur commodi ipsam,
        ipsum nihil enim dignissimos ratione! Dicta, quas ab esse temporibus
        nemo expedita, distinctio quia facilis at eaque deserunt dolorem
        voluptatem blanditiis odio sequi. Aut possimus libero ullam ipsum
        delectus repellat.
      </Typography>
    </Box>
  );
